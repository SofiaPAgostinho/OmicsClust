...
#load data
#filepath = 'C:/Users/inesm/Documents/Tese/Datasets/logCPM_centered.csv'#CS1
#filepath = 'C:/Users/inesm/Documents/Tese/Datasets/logCPM_cent_av.csv' 
filepath = 'C:/Users/inesm/Documents/Tese/Datasets/GSE91383_CS2_filtrado.csv'#CS2
#filepath = 'C:/Users/inesm/Documents/Tese/Datasets/GSE162277_CS3_filtrado.csv' #CS3
case_study2 = pd.read_csv(filepath, delimiter=",", header=0, index_col=0)
cs2 = what_to_cluster(case_study2, 'gene')
...
som_matrix= train_som(som, CS2, 10) #Apos avaliar os erros em 50 iterações, 3 iteraçoes foi o melhor valor
...
som_matrix_2d = reshape_som_matrix(som_matrix)
...
save_training(som_matrix, 'som_matrix.pkl')
...
#portrait = portrait_sample(som_matrix, [0])
...
#portrait_sample_mean(som_matrix, [0,1,2])
...
portrait_all = portrait_all(som_matrix,case_study2.columns.tolist())
...
metagenes_indices = get_metagenes_indices(CS2)
...
metagenes_IDs = metagenes_with_geneIDs(metagenes_indices, cs2)
...
#gene_ids_to_search = ["ENSG00000204531", "ENSG00000111704", "ENSG00000181449", "ENSG00000131914", "ENSG00000179059", "ENSG00000154096"] #POU5F1, NANOG, SOX2, LIN28A, ZFP42,THY1 #pluripotency markers OK
#gene_ids_to_search = ["ENSG00000197616","ENSG00000118194", "ENSG00000129991", "ENSG00000111245","ENSG00000198053","ENSG00000132205"] #MYH6, TNNT2, TNNI3, MYL2, SIRPA, EMILIN2, #immature cardiomyocyte markers 
#gene_ids_to_search = ["ENSG00000164458","ENSG00000166825", "ENSG00000185155", "ENSG00000169071"] #TBXT, ANPEP, MIXL1, ROR2 #mesoderm markers
#gene_ids_to_search = ["ENSG00000166823", "ENSG00000128052", "ENSG00000157404", "ENSG00000121966", "ENSG00000134853"] #MESP1, KDR, KIT, CXCR4, PDGFRA #Cardiac mesoderm markers OK
#gene_ids_to_search = ["ENSG00000016082", "ENSG00000183072", "ENSG00000136574", "ENSG00000089225", "ENSG00000164532", "ENSG00000081189"] #ISL1, NKX2-5, GATA4, TBX5, TBX20, MEF2C #Cardiac progenitor markers

gene_ids_to_search = ["ENSG00000141736", "ENSG00000146648", "ENSG00000164509", "ENSG00000139289"] #ERBB2, EGFR , IL31RA, PHLDA1, EGR1 -- CS2

#gene_ids_to_search = ["Ror2", "Gata4", "Myl2", "Gja1"] #marcadores de diferenciação - CS3. Gata4 (Cardiac progenitor markers), Myl2 (immature cardiomyocyte markers), Gja1 (gap junction protein alpha 1, present from differentiation day 9 and their levels enhanced upon further differentiation)
#gene_ids_to_search = ["Upk3bl", "Ccl22", "Clec10a", "Akr1c14", "Myh7", "Ccl17"]# (17,29),(20,34), (6, 4), (0, 14), (16, 12), (4, 17) # Upregulated. Fetal VS Neo, Adult VS Neo, Adult VS Fetal | Downregulated. Fetal VS Neo, Adult VS Neo, Adult VS Fetal


gene_location_SOM = gene_search_SOM(metagenes_IDs, gene_ids_to_search)
print("Metagenes containing specified gene IDs:", gene_location_SOM)
...
portrait_gene_search = portrait_gene_search(som_matrix, [10])
...
optimal_k = find_optimal_k(som_matrix_2d)
#%%
...
kmeans= kmeans_clustering(som_matrix_2d, 3)
centroids, cluster_labels = kmeans
...
print(f"Inércia (Within-Cluster Sum of Squares): {inertia}")
#%%
...
plot_kmeans_clusters(kmeans[1],3)
...
# Example usage
# Assuming kmeans[1] contains the cluster labels and kmeans[0] contains the cluster centers
plot_kmeans_clusters_label(kmeans[1],3, kmeans[0])
